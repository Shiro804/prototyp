...
INSERT INTO "new_ProcessStep" ("createdAt", "id", "inputSpeed", "inventoryId", "locationId", "name", "outputSpeed", "recipeId", "recipeRate", "status", "updatedAt") SELECT "createdAt", "id", "inputSpeed", "inventoryId", "locationId", "name", "outputSpeed", "recipeId", "recipeRate", "status", "updatedAt" FROM "ProcessStep";
