/*
  ...
  - You are about to drop the column `transportDelay` on the `InventoryEntry` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "TransportSystem" ADD COLUMN "transportDelay" INTEGER DEFAULT 0;
