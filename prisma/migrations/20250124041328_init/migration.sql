...
CREATE TABLE "new_TransportSystem" (
    ...
    CONSTRAINT "TransportSystem_endTSId_fkey" FOREIGN KEY ("endTSId") REFERENCES "TransportSystem" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE UNIQUE INDEX "TransportSystem_endTSId_key" ON "TransportSystem"("endTSId");
